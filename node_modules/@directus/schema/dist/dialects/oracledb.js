                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _loop_1 = function (column) {
                            ...
                            overview[column.table_name].columns[column.column_name] = __assign(__assign({}, column), { is_nullable: column.is_nullable === 'Y', is_generated: column.is_generated === 'YES', default_value: hasAutoIncrement ? 'AUTO_INCREMENT' : (0, strip_quotes_1.stripQuotes)(column.default_value) });
                        };
